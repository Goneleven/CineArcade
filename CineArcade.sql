...
VALUES 
	('104.092.918-46', 'José Santana Pereira', '11 2350-7973', 'josesantana004@outlook.com', 'Rua Professor Jurandyr de Oliveira, Jardim Esperança, 888', '08743-180', 'Mogi Das Cruzes', 'SP', 'Casa Portão Vermelho', '1974-03-17'),
	('099.784.428-04', 'Elza Sophia Lúcia Corte Real', '11 2512-1938', 'Elzasophiaa123@gmail.com', 'Avenida Capitão Arcílio Rizzi, Cézar de Souza, 798', '08820-130', 'Mogi Das Cruzes', 'SP', 'Condominio A', '1956-02-20'),
	('255.527.438-30', 'Manoel Ryan Yago Rocha', '11 3543-8447', 'Manoelryanrocha@outlook.com', 'Rua Loyde Aéreo, Jardim Aeroporto III, 579', '08761-500', 'Mogi Das Cruzes', 'SP', 'Condominio Bloco 7', '1985-07-13'),
    ('826.387.678-83', 'Emanuel Rafael da Rocha', '11 2670-0066', 'Emanuelrocha444@gmail.com', 'Rua João Ribeiro de Brito, Vila Paulista, 546', '08744-030', 'Mogi Das Cruzes', 'SP', 'Villagio Vivendas', '1988-08-19'),
	('715.395.898-38', 'Lara Caroline Souza', '11 2791-2532', 'Laracarolsouzaa@gmail.com', 'Rua Davi Duran, Mogi Moderno, 783', '08717-445', 'Mogi Das Cruzes', 'SP', 'Casa', '1999-01-11');
...
VALUES 
	(01, 'Fornecedor Filmes'),
	(02, 'Fornecedor Jogos'),
	(03, 'Fornecedor Fichas'),
	(04, 'Fornecedor Arcade'),
	(05, 'Fornecedor Alimentação');
